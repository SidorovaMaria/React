...
const ProductsGallery = ({ category }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mx-36 pb-36 ">
      ...
      {/* Category Filter */}
      {/* Search Bar */}
      <div className="flex w-1/2 gap-20  items-center justify-around">
        <input
          type="text"
          placeholder="Search products..."
          value={searchQuery}
          onChange={(e) => setSearchQuery(e.target.value)}
          className=" pl-4 py-2 border rounded-xl text-main text-xl font-semibold outline-main font-mitr flex-1"
        />
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 w-4/5 mt-10">
        {filteredProducts.map((product) => (
          <div
            key={product._id}
            className=" overflow-hidden hover:shadow-[4px_4px_0_white] border-2 border-transparent hover:border-black rounded-xl transition-all"
          >
            {/* Product Image */}
            <div className="">
            ...
            <div className="mt-4 ">
              ...
              <div className="text-left font-AS tracking-wider text-xl px-2">
                {product.discount ? (
